...
class BasketPreferenceInference:
    ...
    def basket_utility(
        ...
        U(basket) = fruit_utility - step_cost x distance
        """
    ...
    def choice_probability(
        ...
        """
        Compute P(chosen | utilities) using softmax. Returns probability of the observed choice.
        """
    ...
    def _apply_wizard_action(
        ...
        """
        Apply wizard action to basket configuration. Returns the final basket configuration after wizard intervention.
        """
        final_config = {
    ...
    def infer_preference_distribution(self, trial_data: Dict[str, Any]) -> Dict[float, float]:
        ...
        farmer_pos_after_wizard = self._get_farmer_position(initial_direction)  # after initial steps
