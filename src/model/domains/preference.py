...
class PreferenceDomain(Domain):
    ...
    def _get_preferred_side(self, theta: float, trial_data: Dict[str, Any]) -> str:
        """
        Determine which side the farmer prefers for a given theta,
        based on the FINAL basket configuration (after wizard action).
        """
    ...
    def compute_necessity(self, trial_data: Dict[str, Any], posterior: Dict[float, float]) -> Dict[str, float]:
        ...
        # 1. Control Necessity (vs "nothing")
        ...
        actual_key = 'nothing_middle' # Default
    ...
    def get_domain_state(self, trial_data: Dict[str, Any], theta: Optional[float] = None) -> WorldState:
        ...
        # Posterior for alignment and necessity
