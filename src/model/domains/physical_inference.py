...
class PreferenceInference:
    ...
    def infer_preference_distribution(self, trial_data: Dict[str, Any]) -> Dict[float, float]:
        ...
        Unifies logic: Always calculate Utility(Right) vs Utility(Left) and apply Rational choice.
        """
        ...
        for theta in thetas:
            ...
            # Initial direction / choice - use softmax for soft rational choice
            ...
            # Distance from current -> Rock (13) -> Banana (0)
    ...
    def alignment_probability(
        ...
        Args:
            theta: Preference parameter (higher = prefers apple)
            actual_outcome: 'apple' or 'banana'
        
        Returns:
            P(farmer prefers actual_outcome | theta) ∈ [0, 1]
        """
