...
class PreferenceGridWorldRenderer {
    constructor(canvas, config = {}) {
        ...
        const displayHeight = this.config.laneHeight + Math.round(310 * this.config.scaleFactor) + 2 * this.config.verticalBorder;
    ...
    drawDescriptiveText(text) {
        ...
        const textY = verticalBorder + laneHeight + 320 * scaleFactor;
