const demographic = {
    ...
    <p>What factors contributed to the sentences you chose?</p>
    <textarea name="factors" cols="50" rows="4"></textarea>
    ...
    on_finish: function(data) {
        let response = {};
        response.factors = data.response.factors;
        ...
        // console.log('Demographic form completed - Data:', response);
    }
};
