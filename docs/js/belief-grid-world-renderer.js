...
class BeliefGridWorldRenderer {
    constructor(canvas, config = {}) {
        ...
        const displayHeight = this.config.laneHeight + Math.round(330 * this.config.scaleFactor) + this.config.verticalBorder;
    ...
    drawDescriptiveText(frame, frameIndex, scene) {
        ...
        const textY = verticalBorder + laneHeight + 310 * scaleFactor;
    ...
    drawTreasureBeliefContent(x, y, bubbleContent, flip, scaleFactor) {
        ...
        if (bubbleContent.goldDir === 'left') {
            ...
            this.ctx.fillText(arrow, currentX + arrowWidth / 2, y - 3);
            ...
            this.ctx.drawImage(treasureImage, currentX, y - treasureSize / 1.65, treasureSize, treasureSize);
